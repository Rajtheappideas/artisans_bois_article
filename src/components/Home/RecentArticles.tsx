...
const RecentArticles = () => {
  ...
  if (articleLoading || homePageLoading) {
    return (
      <div className="w-full flex flex-col gap-2">
        <div className="w-full h-80 animate-pulse ease-in-out bg-gray-200 duration-200"></div>
        <div className="w-full md:h-[50vh] grid lg:grid-cols-3 md:grid-cols-2 gap-3">
          <div className="w-full md:h-full h-40 animate-pulse ease-in-out bg-gray-200 duration-200"></div>
          <div className="w-full md:h-full h-40 animate-pulse ease-in-out bg-gray-200 duration-200"></div>
          <div className="w-full md:h-full h-40 animate-pulse ease-in-out bg-gray-200 duration-200"></div>
          <div className="w-full md:h-full animate-pulse ease-in-out bg-gray-200 duration-200"></div>
          <div className="w-full md:h-full animate-pulse ease-in-out bg-gray-200 duration-200"></div>
          <div className="w-full md:h-full animate-pulse ease-in-out bg-gray-200 duration-200"></div>
        </div>
      </div>
  ...
  return (
    <div className="w-full md:space-y-7 space-y-3">
      ...
      <>
        ...
        >
          {articles.map(({ _id, slug, category, createdAt, title, image }) => (
            <SwiperSlide
              key={_id}
