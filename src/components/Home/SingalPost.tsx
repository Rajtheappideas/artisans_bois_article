...
const SingalPost = ({ image }: singalPostsProps) => {
  return (
    <div className="w-full flex xl:flex-row flex-col 2xl:h-[20vh] xl:h-[30vh] items-start gap-3 rounded-lg shadow-lg p-3">
      <div className="relative xl:h-full 2xl:flex-1 xl:w-[50%] w-full md:h-60 h-40">
        <Image
          src={image.src}
          alt=""
          fill
