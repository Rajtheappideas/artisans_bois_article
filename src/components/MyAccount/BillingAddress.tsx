...
const BillingAddress = ({ setActiveAddress }: BillingAddressProps) => {
  ...
  return (
    ...
    >
      <p className="heading text-lg md:text-left text-center flex items-center justify-between md:py-4 py-2">
